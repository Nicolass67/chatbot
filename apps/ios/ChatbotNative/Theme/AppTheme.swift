...
enum AppTheme {
    ...
    static let accent = Color(hex: 0x7EB8C4)
    static let accentHover = Color(hex: 0x96CBD4)
    static let accentForeground = Color(hex: 0x0E1618)
    static let accentSubtle = Color(hex: 0x7EB8C4).opacity(0.14)
    ...
    /// Status soft — pas de vert/jaune saturés
    static let success = Color(hex: 0x8AA8A4)
    static let warning = Color(hex: 0xB8A090)
    static let border = Color(hex: 0x34343A)
    ...
    static let ambientCool = Color(hex: 0x7A9BA8)
