...
public enum OperationError: LocalizedError, CustomNSError, Sendable, Equatable {
    ...
    case requiresRemotePairing(reason: String? = nil)
    ...
    public var rawDescription: String {
        ...
        case .requiresRemotePairing(let reason):
            if let reason, !reason.isEmpty {
                return "This operation requires Remote Pairing / RSD, which is not available on this device.\n\(reason)"
            }
            return "This operation requires Remote Pairing / RSD (TCP 49152), which is not available on this iPhone."
        case .missingAppBundle:
