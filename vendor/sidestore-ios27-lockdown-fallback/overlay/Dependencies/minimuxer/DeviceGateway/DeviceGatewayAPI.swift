...
public protocol DeviceGatewayAPI: AnyObject, Sendable {
    ...
    var pairingCapabilities: PairingFileCapabilities { get }
    var selectedTransport: DeviceTransport { get }
    var lastLockdownReachable: Bool { get }
    var lastRemotePairingReachable: Bool { get }
    ...
    func applySelectedTransport(_ transport: DeviceTransport) throws
    func recordTransportProbe(_ result: DeviceTransportProbeResult)
